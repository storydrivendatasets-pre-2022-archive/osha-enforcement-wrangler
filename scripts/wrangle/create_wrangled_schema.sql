CREATE TABLE IF NOT EXISTS "accident" (
  "summary_nr" CHAR(9) PRIMARY KEY COLLATE NOCASE,      -- Identifies the accident OSHA-170 form
  "reporting_id" CHAR(7) NOT NULL COLLATE NOCASE,       -- Identifies the OSHA federal or state reporting jurisdiction|original name was "report_id"
  "event_date" DATETIME NOT NULL,
-- always NULL  "event_time" INTEGER,
  "event_desc" VARCHAR(100) COLLATE NOCASE,             -- Short description of event (60 is official max length)
  "event_keyword" VARCHAR(255) COLLATE NOCASE,          -- Contains comma separated keywords entered by ERG during the review process.
  ...
  "sic_list" VARCHAR(40) COLLATE NOCASE,                -- Comma separated 4-digit SICs associated with related inspections
  "fatality" BOOLEAN,
...
CREATE TABLE IF NOT EXISTS "accident_injury" (
  "summary_nr" CHAR(9) NOT NULL COLLATE NOCASE,
  "rel_insp_nr" CHAR(9)  NOT NULL COLLATE NOCASE,
  "age" SMALLINT,
  "sex" CHAR(1),
...
CREATE TABLE IF NOT EXISTS "accident_lookup" (
  "accident_code" VARCHAR(4)  NOT NULL COLLATE NOCASE,
...
CREATE TABLE IF NOT EXISTS "inspection" (
  "activity_nr" CHAR(9) PRIMARY KEY COLLATE NOCASE,   -- Unique identifier for the inspection
  "reporting_id" CHAR(7) NOT NULL COLLATE NOCASE,     -- Identifies the OSHA federal or state reporting jurisdiction
-- always NULL  "state_flag" INTEGER,
  "estab_name" VARCHAR(200),                          -- Establishment being inspected
  "site_address" VARCHAR(200) COLLATE NOCASE,
  "site_city" VARCHAR(200) COLLATE NOCASE,
  "site_state" CHAR(3),                               -- includes non states like JQ, UK, CZ, MN, AS
  "site_zip" CHAR(5) COLLATE NOCASE,
  ...
  "sic_code" CHAR(4) COLLATE NOCASE,
  "naics_code" CHAR(6) COLLATE NOCASE,
  ...
  "migrant" BOOLEAN,
  "mail_street" VARCHAR(200) COLLATE NOCASE,
  "mail_city" VARCHAR(200) COLLATE NOCASE,
  "mail_state" CHAR(3),
  "mail_zip" CHAR(5) COLLATE NOCASE,
  "host_est_key" VARCHAR(20) COLLATE NOCASE,          -- Internal establishment key
...
CREATE TABLE IF NOT EXISTS "optional_info" (
  "activity_nr" CHAR(9) NOT NULL COLLATE NOCASE,
  -- ALWAYS N "opt_type" TEXT,
  "opt_id" INTEGER,                                     -- Optional Information ID| max length of 2
  "opt_value" VARCHAR(50) COLLATE NOCASE                -- Identifies the optional information type (only N type included)
  -- ALWAYS NULL"opt_info_id" INTEGER,
--  "load_dt" DATE NOT NULL
);;--

CREATE TABLE IF NOT EXISTS "related_activity" (
  "activity_nr" CHAR(9) NOT NULL COLLATE NOCASE,         -- Identifies the parent inspection
  "rel_type" CHAR(1),                                    -- C=Complaint.I=Inspection.R=Referral.A=Accident
  "rel_act_nr" CHAR(9) COLLATE NOCASE,
  "rel_safety" BOOLEAN,
  "rel_health" BOOLEAN
--  "load_dt" DATE NOT NULL
);;--
...
CREATE TABLE IF NOT EXISTS "strategic_codes" (
  ...
  "prog_value" CHAR(30) NOT NULL  COLLATE NOCASE                         -- Code value
--  "load_dt" DATE NOT NULL
);;--

CREATE TABLE IF NOT EXISTS "violation" (
  "activity_nr" CHAR(9) NOT NULL COLLATE NOCASE,
  "citation_id" CHAR(7) NOT NULL COLLATE NOCASE,
  "delete_flag" BOOLEAN,
  "standard" CHAR(25) COLLATE NOCASE,                   -- The OSHA standard violated
  ...
  "gravity" INTEGER,
  "emphasis" BOOLEAN,
  "hazcat" VARCHAR(10) COLLATE NOCASE,                 -- General industry standard hazard category
  "fta_insp_nr" INTEGER,
...
CREATE TABLE IF NOT EXISTS "violation_event" (
  "activity_nr" CHAR(9) NOT NULL COLLATE NOCASE,
  "citation_id" CHAR(7) NOT NULL COLLATE NOCASE,      -- Identifies the citation number. item number. and item group of the associated citation.
  ...
  "hist_vtype" CHAR(1),
  "hist_insp_nr" CHAR(9) COLLATE NOCASE,              -- FTA inspection nr -when pen-fta=F
  "load_dt" DATE NOT NULL
);;--
